...
| marketplace-zalando        | ![](./icons/marketplace-zalando.svg)        | `./icons/marketplace-zalando.svg`        | `<IconMarketplaceZalando class="icon" />`       |
...
| sso-provider-google        | ![](./icons/sso-provider-google.svg)        | `./icons/sso-provider-google.svg`        | `<IconSsoProviderGoogle class="icon" />`        |
| sso-provider-azure         | ![](./icons/sso-provider-azure.svg)         | `./icons/sso-provider-azure.svg`         | `<IconSsoProviderAzure class="icon" />`         |
